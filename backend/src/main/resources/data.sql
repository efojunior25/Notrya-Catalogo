...
('Camiseta Básica Preta', 'Camiseta básica de algodão 100% preta, corte masculino', 29.90, 50, 'CAMISETA', 'M', 'PRETO', 'BasicWear', 'Algodão 100%', 'MASCULINO', '/uploads/camiseta-basica-preta.jpg', true, NOW(), 0),
('Camiseta Básica Preta', 'Camiseta básica de algodão 100% preta, corte masculino', 29.90, 45, 'CAMISETA', 'G', 'PRETO', 'BasicWear', 'Algodão 100%', 'MASCULINO', '/uploads/camiseta-basica-preta.jpg', true, NOW(), 0),
